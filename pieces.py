...
class Pawn(Pieces):
    ...
    def getPossibleMoves(self):
        ...
        if self.canAttack:
            self.possible_moves.append([-9,11])
...
class Knight(Pieces):
    def __init__(self, team,init_x):
        ...
        self.possibleMoves = [12,21,19,-12,8,-21,-19,-8]
        super().__init__(image, team, init_x, init_y)
...
class Bishop(Pieces):
    def __init__(self, team,init_x):
        ...
        init_y = {"white": 0, "black": 7}[team]
        self.possibleMoves = [[11, 22, 33, 44, 55, 66, 77], [-11, -22, -33, -44, -55, -66,
...
class Rook(Pieces):
    def __init__(self, team,init_x):
        ...
        init_y = {"white": 0, "black": 7}[team]
        self.possibleMoves = [[1, 2, 3, 4, 5, 6, 7],[ 10, 20, 30, 40, 50, 60,
...
class King(Pieces):
    def __init__(self, team,init_x):
        ...
        init_x = 4
        init_y = {"white": 0, "black": 7}[team]
        self.possibleMoves = [11, -11, -9, 9,1,-1,10,-10]
        super().__init__(image, team, init_x, init_y)
